...
# Import csv file
df = pd.read_csv('C:\Users\debjy\PycharmProjects\pedometer_project\datasets\walking.csv')
...
axs[0].plot(time_line, np.array(thres), color='Red')
...
axs[2].set_ylabel('Detected Peaks')
axs[2].grid(True)
# fig.tight_layout()
plt.show()
